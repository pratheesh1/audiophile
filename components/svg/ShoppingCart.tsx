...
export type TShoppingCartProps = {
  ...
  className?: Pick<TClassName, "className">;
};

export default function ShoppingCart(props?: TShoppingCartProps) {
  const { numberOfItems, className } = props || { numberOfItems: undefined };
